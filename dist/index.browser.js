...
const transformAttributes = (rule) => {
    ...
    else if (!Array.isArray(rule.attributes)) {
        rule.attributes = Array.from(rule.attributes);
    }
...
globalThis.PurifyHTML = {
    sanitizer: _core__WEBPACK_IMPORTED_MODULE_0__.PurifyHTML,
    setParser: _core__WEBPACK_IMPORTED_MODULE_0__.setParser,
};
