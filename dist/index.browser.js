...
class PurifyHTML {
  constructor() {
    let allowedTags = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
    ...
    this.allowedTags = allowedTags.reduce((acc, curr) => {
      switch (typeof curr) {
        case 'string':
          ...
          break;
        case 'object':
          acc[curr.name] = Object.assign(acc[curr] || {}, (0,_utils_js__WEBPACK_IMPORTED_MODULE_0__.transformAttributes)(curr));
      }
      return acc;
    }, {});
  ...
  sanitize(str) {
    ...
    allItems.forEach(tag => {
      ...
      if (this.whiteList.includes(name)) {
        ...
        if (Object.prototype.hasOwnProperty.call(tagConfig, 'attributes') && tagConfig.attributes.length > 0) {
          let deleteList = [];
          let clearList = [];
            ...
            if (!attributeRules) {
              ...
              if (typeof attributeRules.value === 'string') {
                ...
                if (Object.prototype.hasOwnProperty.call(attributeRules.value, 'preset')) {
                  ...
                  if (Object.prototype.hasOwnProperty.call(_utils_js__WEBPACK_IMPORTED_MODULE_0__.valuesPresets, attributeRules.value.preset)) {
                    const presetRes = _utils_js__WEBPACK_IMPORTED_MODULE_0__.valuesPresets[attributeRules.value.preset](attr.value);
                    if (presetRes.remove) {
                      clearList.push(attr.name);
                    }
                  } else {
  ...
  toHTMLEntities(str) {
    return str.split('').map(n => `&#${n.charCodeAt()};`).join('');
  }
}
const setParser = function () {
  let customParser = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
...
self.PurifyHTML = {
  sanitizer: _core_js__WEBPACK_IMPORTED_MODULE_0__.PurifyHTML,
  setParser: _core_js__WEBPACK_IMPORTED_MODULE_0__.setParser
};
}();
var __webpack_export_target__ = (PurifyHTML = typeof PurifyHTML === "undefined" ? {} : PurifyHTML);
